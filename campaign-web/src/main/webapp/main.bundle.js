...
var HeaderComponent = (function () {
    function HeaderComponent(translate, router, user) {
        var _this = this;
        this.translate = translate;
        this.router = router;
        this.user = user;
...
var UserService = (function () {
    ...
    UserService.prototype.getUserDetails = function () {
        ...
        return this.http.get('http://localhost:8080/campaign/user');
